...
dir_1PSI='/uufs/chpc.utah.edu/common/home/flin-group5/qicheng/specfem2d/EXAMPLES/Rayleigh_wave_SRP_LocWid/'
...
def func_data0_0(per,dir_SAC):
    ...
    for ista in tqdm(range(len(Stas))): #['033']: #HV for sta1
        ...
        for comp in Comps:
            ...
            perA,snrPreA,snrFolA=np.loadtxt(fp+'_snr_rms.txt',usecols=[0,1,2],dtype=float,unpack=True)
            snr2Comps.append(get_valT(per,perA,snrPreA))
            # try:
        ...
        if True:
            ...
            # pass
            fPhV_ZZ.append('%d %.6f %s %s %.6f'%(k,phv2Comps[0],sta1,'EHZ',dist))
...
for per in tqdm([40,50,60,70,80,90]):
# per=60
    ...
    for mode in [0,10]:
        Para_Pool.append((per,dir_1PSI+'/OUTPUT_SRP_SOURCEL_Lock_wavefieldGJI_Mode%d_WithRef0_10/SAC/'%mode))
        Para_Pool.append((per,dir_1PSI+'/OUTPUT_SRP_SOURCER_Lock_wavefieldGJI_Mode%d_WithRef0_10/SAC/'%mode))
...
dirSL=dir_1PSI+'OUTPUT_SOURCEL_txt/SAC/'
dirSR=dir_1PSI+'OUTPUT_SOURCER_txt/SAC/'

# dirM0L=dir_1PSI+'OUTPUT_SRP_SOURCEL_Lock_wavefield_ModeAll_WithRef0_0/SAC/'
# dirM0R=dir_1PSI+'OUTPUT_SRP_SOURCER_Lock_wavefield_ModeAll_WithRef0_0/SAC/'

dirM0L=dir_1PSI+'OUTPUT_SRP_SOURCEL_Lock_wavefieldGJI_Mode0_WithRef0_10/SAC/'
dirM0R=dir_1PSI+'OUTPUT_SRP_SOURCER_Lock_wavefieldGJI_Mode0_WithRef0_10/SAC/'

# dirM10L=dir_1PSI+'OUTPUT_SRP_SOURCEL_Lock_wavefield_ModeAll_WithRef0_10/SAC/'
# dirM10R=dir_1PSI+'OUTPUT_SRP_SOURCER_Lock_wavefield_ModeAll_WithRef0_10/SAC/'

dirM10L=dir_1PSI+'OUTPUT_SRP_SOURCEL_Lock_wavefieldGJI_Mode10_WithRef0_10/SAC/'
dirM10R=dir_1PSI+'OUTPUT_SRP_SOURCER_Lock_wavefieldGJI_Mode10_WithRef0_10/SAC/'

CPS_10km=C_Psi1(dirSL,dirSR,per,10,dXShift,'Z')
# CPS_1km=C_Psi1(dirSL,dirSR,per,1,dXShift,'Z')
CPS_70km=C_Psi1(dirSL,dirSR,per,70,dXShift,'Z')

CP0_10km=C_Psi1(dirM0L,dirM0R,per,10,dXShift,'Z')
CP0_70km=C_Psi1(dirM0L,dirM0R,per,70,dXShift,'Z')

CP10_10km=C_Psi1(dirM10L,dirM10R,per,10,dXShift,'Z')
CP10_70km=C_Psi1(dirM10L,dirM10R,per,70,dXShift,'Z')
...
TRANSPARENT=False
# plt.savefig('/uufs/chpc.utah.edu/common/home/u1318104/Figures/Figures_1Psi/Fig4_1psi_SPECFEM2D.png',transparent=TRANSPARENT,dpi=300)
# plt.savefig('/uufs/chpc.utah.edu/common/home/u1318104/Figures/Figures_1Psi/Fig4_1psi_SPECFEM2D.eps',transparent=TRANSPARENT)

plt.savefig('/uufs/chpc.utah.edu/common/home/u1318104/Figures/Figures_1Psi/Fig4_1psi_SPECFEM2D_AGU2023.png',transparent=TRANSPARENT,dpi=300)
plt.savefig('/uufs/chpc.utah.edu/common/home/u1318104/Figures/Figures_1Psi/Fig4_1psi_SPECFEM2D_AGU2023.eps',transparent=TRANSPARENT)
...
ax1=fig.add_subplot(gs[0,0])
# ax1.plot(CP0_10km.XXStaVph,CP0_10km.VphStaL_smooth,'g--^',markersize=4,linewidth=2,label='Mode 0')
# ax1.plot(CP10_10km.XXStaVph,CP10_10km.VphStaL_smooth,'b--^',markersize=4,linewidth=2,label='Mode 0-9')
...
ax2=fig.add_subplot(gs[1,0])
# ax2.plot(CPS_10km.XXStaVph,CP0_10km.VphStaR_smooth,'g--^',markersize=4,linewidth=2,label='Mode 0')
# ax2.plot(CPS_10km.XXStaVph,CP10_10km.VphStaR_smooth,'b--^',markersize=4,linewidth=2,label='Mode 0-9')
...
# plt.savefig('/uufs/chpc.utah.edu/common/home/u1318104/Figures/Figures_1Psi/Fig7A_1psi_NM_AGU2023.png',transparent=TRANSPARENT,dpi=300)
# plt.savefig('/uufs/chpc.utah.edu/common/home/u1318104/Figures/Figures_1Psi/Fig7A_1psi_NM_AGU2023.eps',transparent=TRANSPARENT)
#%%
